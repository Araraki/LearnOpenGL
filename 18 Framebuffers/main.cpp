...
// shader
Shader baseShader, windowShader, screenShader;
// texture
GLuint boxTex, grassTex, windowTex;
void LoadResources()
{
	// shader 
	...
	// texture
	boxTex = TextureManager::Inst()->LoadTexture("box.png", GL_RGBA, GL_RGBA, 0, 0);
	...
	grassTex = TextureManager::Inst()->LoadTexture("grass.png", GL_RGBA, GL_RGBA, 0, 0);
	glGenerateMipmap(GL_TEXTURE_2D);
	...
	windowTex = TextureManager::Inst()->LoadTexture("window.png", GL_RGBA, GL_RGBA, 0, 0);
	glGenerateMipmap(GL_TEXTURE_2D);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
...
// --- main code ---
float currentTime = 0.0f, deltaTime = 0.0f, lastFrame = 0.0f;
